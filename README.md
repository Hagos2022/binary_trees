...
* **33. AVL - Remove**
  * [123-avl_remove.c](./123-avl_remove.c): C function that removes a node from
  an AVL tree.

* **34. AVL - From sorted array**
  * [124-sorted_array_to_avl.c](./124-sorted_array_to_avl.c): C function that
...
* **36. Is Binary heap**
  * [130-binary_tree_is_heap.c](./130-binary_tree_is_heap.c): C function that
  checks if a binary tree is a valid Max Binary Heap.

* **37. Heap - Insert**
  * [131-heap_insert.c](./131-heap_insert.c): C function that inserts a value
  in Max Binary Heap.

* **38. Heap - Array to Binary Heap**
  * [132-array_to_heap.c](./132-array_to_heap.c): C function that builds a
  Max Binary Heap tree from an array.

* **39. Heap - Extract**
  * [133-heap_extract.c](./133-heap_extract.c): C function that extracts
  the root node of a Max Binary Heap.

* **40. Heap - Sort**
  * [134-heap_to_sorted_array.c](./134-heap_to_sorted_array.c): C function that
...
* __Ogechukwu Benedicta__ <[Ogeben1](https://github.com/Ogeben1)>
